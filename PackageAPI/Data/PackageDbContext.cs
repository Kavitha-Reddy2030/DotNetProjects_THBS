...
//             {
//                 entity.HasKey(pc => pc.Id); // Primary Key
...
//             {
//                 entity.HasKey(pr => pr.Id); // Primary Key
...
//                 new PackageCity { Id = 1, PackageId = 1, CityId = 1, Description = "Beach Holiday in Los Angeles" },
//                 new PackageCity { Id = 2, PackageId = 2, CityId = 2, Description = "City Tour in Toronto" },
//                 new PackageCity { Id = 3, PackageId = 1, CityId = 3, Description = "Beach Holiday in San Francisco" }
//             );

//             // Seed data for PackageResort
//             modelBuilder.Entity<PackageResort>().HasData(
//                 new PackageResort { Id = 1, PackageId = 1, ResortId = 1, Description = "Luxury Beach Resort" },
//                 new PackageResort { Id = 2, PackageId = 1, ResortId = 2, Description = "Affordable Beach Resort" },
//                 new PackageResort { Id = 3, PackageId = 2, ResortId = 3, Description = "City Resort with Amenities" }
//             );
//         }
//     }
// }
    ...
    public class PackageDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Country>(entity =>
            {
                ...
                entity.HasIndex(c => c.CountryName).IsUnique();
                entity.Property(c => c.CountryName).IsRequired();
            });
            ...
            modelBuilder.Entity<State>(entity =>
            {
                ...
                entity.HasIndex(s => new { s.StateName }).IsUnique();
                entity.Property(s => s.StateName).IsRequired();
            ...
            modelBuilder.Entity<City>(entity =>
            {
                ...
                entity.HasIndex(c => new { c.CityName }).IsUnique();
                entity.Property(c => c.CityName).IsRequired();
            ...
            // Define Package entity with CreatedOn defaulting to current date/time and Status defaulting to true
            modelBuilder.Entity<Package>(entity =>
            {
                ...
                // Set default value for CreatedOn and Status
